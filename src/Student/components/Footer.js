        ...
        <div className="grid sm:grid-cols-12 gap-8 py-8 md:py-12 border-t border-gray-200">
          ...
          <div className="sm:col-span-6 lg:col-span-3">
            ...
            <ul className="text-sm">
              ...
              <li className="mb-2">
                <Link to="#" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Person C</Link>
              </li>
              <li className="mb-2">
                <Link to="#" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Person D</Link>
              </li>
              <li className="mb-2">
                <Link to="#" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Person E</Link>
              </li> */}
            </ul>
          </div>
          ...
          <div className="sm:col-span-6 lg:col-span-3">
            ...
            {/* flex justify-between flex-wrap */}
              ...
              <li className="mb-2">
                <Link to="#" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Placement Policy</Link>
              </li>
            </ul>
          </div>
